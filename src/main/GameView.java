...
public class GameView extends UserView {
  ...
  protected void paintForeground(Graphics2D g) {
      ...
      // Position of the health bar on the screen
      int healthBarX = 30;
      int healthBarY = 40;
      ...
      // Draw the red part of the health bar inside the border
      ...
      // Set text color to white and position it on the health bar
